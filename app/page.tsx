  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold mb-2">100%審査通過</h4>
              <p className="text-sm text-gray-600">規格完全準拠で審査通過率100%、不通過なら全額返金</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-3xl font-bold text-center mb-8">マイナンバーカード写真の要件</h3>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8">
                <div className="flex-shrink-0">
                  <div className="w-48 h-48 bg-white rounded-lg flex items-center justify-center border-4 border-emerald-500">
                    <Image
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-49kwNDZLrgqB5WfpMzfgDCAFYlsZ0E.png"
                      alt="写真要件サンプル"
                      width={180}
                      height={180}
                      className="rounded"
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-6 p-4 bg-white rounded-lg border border-emerald-200">
                    <h4 className="font-semibold text-emerald-800 mb-2">オンライン申請の場合</h4>
